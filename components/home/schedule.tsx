  ...
  return (
    <section className="bg-soft-white px-5 py-20 sm:px-8 sm:py-28 lg:px-12">
      <div className="mx-auto max-w-7xl">
        ...
        <p className="mt-5 max-w-xl text-base leading-7 text-charcoal/65">{schedulerUrl ? bookingCopy[locale].intro : h.scheduleIntro}</p>
        <div className="mt-12">
          <AcuityScheduler
            placeholder={schedulerUrl ? bookingCopy[locale].title : h.schedulePlaceholder}
